...
alias mvpb='cppb --remove-source-files' # Move with a neat little progress par
alias smvpb='scppb --remove-source-files' # Move with a neat little progress par (SUPER USER EDITION)
...
alias mntsdb='sudo mount -m /dev/sdb /mnt/sdb' # Mount sdb
alias mntsdb1='sudo mount -m /dev/sdb1 /mnt/sdb1' # Mount sdb1
alias mntsdb2='sudo mount -m /dev/sdb2 /mnt/sdb2' # Mount sdb2 (TODO more sdbs and also sdc sdd)
