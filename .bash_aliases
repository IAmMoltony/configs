...
alias mntsdb='sudo mount -m /dev/sdb /mnt' # Mount sdb
alias mntsdb1='sudo mount -m /dev/sdb1 /mnt' # Mount sdb1
alias mntsdb2='sudo mount -m /dev/sdb2 /mnt' # Mount sdb2 (TODO more sdbs and also sdc sdd)
